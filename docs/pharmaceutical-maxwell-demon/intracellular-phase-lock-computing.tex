...
Contemporary pharmacology describes drug action through binding to molecular targets—receptors, enzymes, ion channels—that trigger downstream signaling cascades \cite{Langley1905,Ehrlich1913}. This mechanistic view treats therapeutic intervention as perturbation of biochemical pathways. We propose a fundamentally different perspective: \textit{pharmaceutical agents program intracellular computational substrates through oxygen-mediated phase-lock propagation}.
